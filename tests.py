...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        result = self.client.get("/")
        self.assertIn(b"I'm having an after-party!", result.data)
    ...
    def test_rsvp(self):
        ...
        # not the RSVP form
        self.assertIn(b"San Francisco, CA", result.data)
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn(b"human game", result.data)
        self.assertIn(b"fish game", result.data)
        self.assertIn(b"pet game", result.data)
